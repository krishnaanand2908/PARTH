...
def guess_game_v5(n):
    ...
    print(fontstyle.apply(
        f"You have to guess a number between 1 to {n}\nYou will only get 9 chances!\n Enjoy :-)", "Cyan/bold"))
    speak(
        f"You have to guess a number between 1 to {n}, You will only get 9 chances!, ENJOY!")
    ...
    while (guess <= 9):
        ...
        if guessed_number == '-29001':
            ...
            print(fontstyle.apply(f"Turns remaining: {9-guess}", 'white/bold'))
            print(fontstyle.apply('Number is reassined!', ' red/bold'))
